...
| `...packages.<name>.tags`         | 1–5 tags from the closed vocabulary in [`schema/tags.yaml`](schema/tags.yaml) (`sensing`, `perception`, `planning`, ...). Unknown or deprecated tags are rejected by CI.                                                     |
